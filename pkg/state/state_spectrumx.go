...
func NewStateSpectrumXOperator(
	...
	state := &stateStateSpectrumXOperator{
		stateSkel: stateSkel{
...
type stateStateSpectrumXOperator struct {
	stateSkel
}
...
//
//nolint:dupl
func (s *stateStateSpectrumXOperator) Sync(
...
func (s *stateStateSpectrumXOperator) GetWatchSources() map[string]client.Object {
...
func (s *stateStateSpectrumXOperator) GetManifestObjects(
