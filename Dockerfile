...
FROM golang:1.25@sha256:0afe9b553123ec160b8282154b7156241ebf43c9033ea2bf9528c6c58c17e89d AS builder
...
FROM --platform=linux/${ARCH} nvcr.io/nvidia/distroless/go:v3.2.0
