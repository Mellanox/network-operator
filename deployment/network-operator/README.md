...
| `ofedDriver.containerResources`                 | []     | `[{"name": "mofed-container", "requests": {}, "limits": {}}]` | Optional [resource requests and limits](https://kubernetes.io/docs/concepts/configuration/manage-resources-containers/) for the container                                |
...
| `rdmaSharedDevicePlugin.containerResources` | []     | `[{"name": "rdma-shared-dp", "requests": {}, "limits": {}}]` | Optional [resource requests and limits](https://kubernetes.io/docs/concepts/configuration/manage-resources-containers/) for the container |
...
| `sriovDevicePlugin.containerResources` | []     | `[{"name": "kube-sriovdp", "requests": {}, "limits": {}}]` | Optional [resource requests and limits](https://kubernetes.io/docs/concepts/configuration/manage-resources-containers/) for the container |
...
| `ibKubernetes.containerResources`     | []     | `[{"name": "ib-kubernetes", "requests": {}, "limits": {}}]` | Optional [resource requests and limits](https://kubernetes.io/docs/concepts/configuration/manage-resources-containers/) for the container |
...
| `cniPlugins.containerResources` | []     | `[{"name": "cni-plugins", "requests": {}, "limits": {}}]` | Optional [resource requests and limits](https://kubernetes.io/docs/concepts/configuration/manage-resources-containers/) for the container |
...
| `multus.containerResources` | []     | `[{"name": "kube-multus", "requests": {}, "limits": {}}]` | Optional [resource requests and limits](https://kubernetes.io/docs/concepts/configuration/manage-resources-containers/) for the container                                                               |
...
| `ipoib.containerResources` | []     | `[{"name": "ipoib-cni", "requests": {}, "limits": {}}]` | Optional [resource requests and limits](https://kubernetes.io/docs/concepts/configuration/manage-resources-containers/) for the container |
...
| `ipamPlugin.containerResources` | []     | `[{"name": "whereabouts", "requests": {}, "limits": {}}]` | Optional [resource requests and limits](https://kubernetes.io/docs/concepts/configuration/manage-resources-containers/) for the container |
...
| `nvIpam.containerResources` | []     | `[{"name": "nv-ipam-node", "requests": {}, "limits": {}},{"name": "nv-ipam-controller", "requests": {}, "limits": {}}]` | Optional [resource requests and limits](https://kubernetes.io/docs/concepts/configuration/manage-resources-containers/) for the container                                                               |
...
| `nicFeatureDiscovery.containerResources` | []     | `[{"name": "nic-feature-discovery", "requests": {}, "limits": {}}]` | Optional [resource requests and limits](https://kubernetes.io/docs/concepts/configuration/manage-resources-containers/) for the container |
