...
│   ├── pods/
│   │   ├── <pod-name>.yaml           # Pod spec and status
│   │   ├── <pod-name>.log            # Pod logs
│   │   └── <pod-name>-previous.log   # Previous logs if restarted
│   ├── configmaps/
...
cat network-operator-sosreport-*/components/ofed-driver/pods/*.log
```
