...
// TODO: replace github.com/heyvister1/k8s-operator-libs one PR is merged
replace github.com/NVIDIA/k8s-operator-libs => github.com/heyvister1/k8s-operator-libs v0.0.0-20250407084942-8561552fe6bf
